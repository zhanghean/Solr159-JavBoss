      ...
      <form onSubmit={handleSubmit}>
        <div className="border-b border-gray-200 px-5 py-4">
          ...
          <p className="mt-1 text-sm text-gray-500">
            {zh(
              '创建后可在作品编辑中补充演员、标签、评分和封面。',
              'Add cast, tags, rating, and cover after creating the work.'
            )}
          </p>
        </div>
        ...
        <div className="flex justify-end gap-2 border-t border-gray-200 px-5 py-4">
          ...
          <button
            type="submit"
            className={`rounded-md px-4 py-2 text-sm font-medium text-white ${saving ? 'cursor-wait bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'}`}
            disabled={saving}
          >
